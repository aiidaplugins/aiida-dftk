...
project = 'aiida-dftk'
copyright = '2022-{}, ECOLE POLYTECHNIQUE FEDERALE DE LAUSANNE (Theory and Simulation of Materials (THEOS) and National Centre for Computational Design and Discovery of Novel Materials (NCCR MARVEL)), Switzerland. All rights reserved'.format(
    time.localtime().tm_year
)
# The full version, including alpha/beta/rc tags.
release = aiida_dftk.__version__
# The short X.Y version.
version = '.'.join(aiida_dftk.__version__.split('.')[:2])
...
html_use_opensearch = 'http://aiida-dftk.readthedocs.io'
...
htmlhelp_basename = 'aiida-dftkdoc'
