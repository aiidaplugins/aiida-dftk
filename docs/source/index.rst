...
The |aiida-dftk|_ package is an `AiiDA`_ plugin for running calculations and workflows with `DFTK`_.

Installation
============

You can install ``aiida-dftk`` in your Python environment using ``pip``:

.. code-block:: console

   $ pip install aiida-dftk
